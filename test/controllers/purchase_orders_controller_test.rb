...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { amount: @purchase_order.amount, balance: @purchase_order.balance, discount: @purchase_order.discount, paid_amount: @purchase_order.paid_amount, quantity: @purchase_order.quantity }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { amount: @purchase_order.amount, balance: @purchase_order.balance, discount: @purchase_order.discount, paid_amount: @purchase_order.paid_amount, quantity: @purchase_order.quantity }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
